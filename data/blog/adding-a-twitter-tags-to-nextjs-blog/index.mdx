...
![Screenshot_2021-03-31_22-02-28](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/17e6tvvt9diday3dhrig.png)

<!-- <Image
  alt={`Web vitals`}
  src={`/static/images/how-to-add-twitter-tags-to-nextjs-blog/example.png`}
  width={1200}
  height={630}
/> -->
