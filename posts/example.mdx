...
description: Learn how to create server side paginated table with react-table library
---
...
![final result of the code](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/9sr3ctaozf7wmu6dwpc0.gif)
...
This is a bit long code to include all of it here. So you can check the rest of it from [my github repo](https://github.com/uguremirmustafa/server-side-paginated-table-with-react-table). Cheers!!
