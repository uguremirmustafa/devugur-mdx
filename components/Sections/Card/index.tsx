      ...
      <Link href={`/${cardType}/${slug}`} key={slug}>
        ...
        >
          <div className="flex flex-col md:flex-row justify-between mb-2">
            <h4>
              <span className="card-title bg-clip-text text-transparent dark:text-transparent bg-gradient-to-br from-gray-600 to-gray-900 dark:from-yellow-400  dark:to-yellow-600 ">
                {title}
              </span>
            </h4>
